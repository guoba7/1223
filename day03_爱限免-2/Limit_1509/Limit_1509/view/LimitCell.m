...
-(void)configModel:(LimitModel *)model index:(NSInteger)index cutLength:(NSInteger)cutLenght
{
    //背景图片
    if (index % 2 == 0) {
    ...
    //时间
    NSString *dateStr = [model.expireDatetime substringToIndex:model.expireDatetime.length-cutLenght];
    //转化成日期
